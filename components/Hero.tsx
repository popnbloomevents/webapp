...
export function Hero(){
  ...
  return <section ref={hero} className="hero" id="top">
    ...
    <div className="container hero-content"><p className="eyebrow light hero-eyebrow">Metro Vancouver event styling</p><h1 className="hero-title">Creating celebrations<br/><span className="accent">that pop &amp; bloom.</span></h1><p className="hero-body">Balloon decor, custom backdrops, and a vintage video guestbook—thoughtfully styled for birthdays, baptisms, milestones, and celebrations across Metro Vancouver.</p><div className="hero-actions"><a className="button" href="#contact">Plan Your Event</a><a className="button button-outline" href="#portfolio">View Our Work</a></div></div>
